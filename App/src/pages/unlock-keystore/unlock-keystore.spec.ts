...
describe("TravelPage", () => {
    let comp: UnlockKeystorePage;
    let fixture: ComponentFixture<UnlockKeystorePage>;
    ...
    beforeEach(async(() => {
        ...
        TestBed.configureTestingModule({
            declarations: [UnlockKeystorePage],
            imports: [
                IonicModule.forRoot(UnlockKeystorePage),
                ComponentsModule
            ],
            providers: [
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(UnlockKeystorePage);
